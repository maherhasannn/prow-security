      ...
      <div className="max-w-[var(--container-max-width)] mx-auto">
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          <motion.div
            ...
            className="relative h-[500px] bg-gradient-to-br from-[#3A6A7B]/5 to-[#3A6A7B]/10 rounded-sm overflow-hidden order-2 lg:order-1 border border-[#3A6A7B]/10"
          >
          ...
          >
            ...
            <h2 className="text-4xl md:text-5xl font-heading font-bold mb-6 text-balance text-[#3A6A7B]">
              ...
              {features.map((feature, featureIndex) => {
                ...
                return (
                  <motion.div
                    ...
                    className="border-l-2 border-[#3A6A7B] pl-6"
                  >
                    <div className="flex items-center gap-3 mb-4">
                      <div className="p-2 bg-[#3A6A7B]/10 rounded-sm">
                        <IconComponent className="w-5 h-5 text-[#3A6A7B]" />
                      </div>
                      <h3 className="text-xl font-heading font-semibold text-[#3A6A7B]">{feature.title}</h3>
                      {feature.critical && (
                        <span className="px-2 py-0.5 bg-[#3A6A7B]/10 text-[#3A6A7B] text-xs font-heading font-semibold uppercase tracking-wider rounded-full flex items-center gap-1">
